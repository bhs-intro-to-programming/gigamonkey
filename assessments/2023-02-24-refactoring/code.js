...
const hisHead = (x, headY, headRadius) => {
...
hisHead(x, headY, headRadius)
  //drawCircle(x, headY, headRadius + 2, 'black', 3);
  //drawFilledCircle(x, headY, headRadius, 'white', 3);


  const eyeBalls = (s) => {
    drawFilledCircle(x + (eyeSpacing * s), headY - eyeSpacing, 4, 'black');
  }
  // Draw the eyes
